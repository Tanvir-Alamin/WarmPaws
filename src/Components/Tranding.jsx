...
const Tranding = () => {
  ...
  return (
    <div>
      {" "}
      <div data-aos="fade-up" className="mt-45 relative">
        <img
          className="w-95 absolute hidden md:block  mt-[-120px] ml-[-50px]"
          src={catPlay}
          alt=""
        />
        <div className="flex flex-col justify-center items-center">
          <div className="flex items-center mb-15">
            {" "}
            <p className="text-4xl font-bold">Popular Pet Care Services</p>{" "}
          ...
          <div className="grid  grid-cols-2 gap-10  md:grid-cols-3">
            {services.slice(0, 6).map((service) => (
              <div
                ...
                className="card w-50 md:w-90  hover:scale-105 transform transition-all duration-300 ease-in-out bg-base-100 shadow-lg"
              >
        ...
        <div className="flex justify-center">
          <Link
            to="/services"
            className=" bg-amber-300 rounded-xl text-lg btn my-15 "
          >
            View more →
          </Link>
        </div>
